...
export function OrderFormPage() {
      ...
      try {
        ...
        if (mode === "create") {
          ...
          const { cliente: criado, status: statusCriarCliente } =
            await criarCliente(
              clientePayloadDaOrdem(orderWithCode),
              rtdbToken,
            );
  ...
  return (
    <div className="order-form-layout order-form-print-root">
      <div className="order-form-toolbar print:hidden">
        <Button
          type="button"
          variant="outline"
      ...
      <div
        ref={orderPdfRef}
        className="order-form-pdf-capture w-full min-w-0"
      >
      ...
      <form className="order-form" onSubmit={handleFormSubmit} noValidate>
          ...
          <div className="order-form-type-toggle">
            ...
            <label className="flex cursor-pointer items-center gap-1.5 font-normal">
              <input
                ...
                onChange={() => formik.setFieldValue("formType", "assistencia")}
                className="accent-indigo-600"
              />
              Assistência técnica
            </label>
        ...
        <section className="order-form-section order-form-section-print">
          ...
          <div className="order-form-grid-service-meta">
            <div className="order-form-field min-w-0">
          ...
          <div className="order-form-grid-textareas">
            <div className="order-form-field min-w-0">
        ...
        <footer className="order-form-footer order-form-footer-row">
          <div className="order-form-footer-client">
            <label className="order-form-terms-accept flex cursor-pointer items-start gap-2 text-[0.85rem] leading-snug">
              <input
                type="checkbox"
                name="aceitoTermos"
            ...
            <div className="order-form-signature mt-4">
              <p className="mb-1 text-center text-[0.75rem] text-zinc-500">
          ...
          <div className="order-form-footer-actions print:hidden">
            {clienteId ? (
              <Button
                type="button"
                variant="outline"
